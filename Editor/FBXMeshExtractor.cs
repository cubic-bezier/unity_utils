 ...
 * C# Script Header
 * 
 * Script Name: FBXMeshExtractor
 * Creator: WaterfordSS [Reddit]
 * Date Found: 04/15/2024 11:10 UTC
 * 
 * Description: FBX submeshes extractor utility script.
 * 
 * Remember to place it in the Editor/ folder
 * 
 * Original post: https://www.reddit.com/r/Unity3D/comments/59pywj/extracting_meshes_from_fbx_files/
 * 
 */
